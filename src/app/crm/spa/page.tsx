  ...
  return (
    <main className="relative min-h-screen px-6 py-20 text-white">
      ...
      <div className="relative z-20 max-w-6xl mx-auto text-center">
        <h1 className="text-4xl font-bold mb-10 drop-shadow-xl flex items-center justify-center gap-3">
          <Spa className="w-8 h-8 text-pink-300" /> CRM Institut / Spa
        </h1>
        <p className="text-lg text-gray-200 mb-12">
          Gérez vos soins, clients et plannings avec une solution IA fluide et adaptée à votre activité bien-être.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: "Rendez-vous", href: "/crm/spa/agenda", emoji: "📅" },
            { title: "Prestations & Soins", href: "/crm/spa/soins", emoji: "🧴" },
            { title: "Clients Spa", href: "/crm/spa/clients", emoji: "🧘‍♀️" },
            { title: "Messages & Rappels", href: "/crm/spa/messages", emoji: "💬" },
            { title: "Scoring fidélité IA", href: "/crm/spa/scoring", emoji: "🤖" },
            { title: "Facturation & Suivi", href: "/crm/spa/factures", emoji: "📄" },
