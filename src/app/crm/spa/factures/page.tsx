...
export default function SpaFacturesPage() {
  return (
      ...
      <div className="relative z-20 max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-10">
          <h1 className="text-3xl font-bold drop-shadow flex items-center gap-2">
            <FileText className="w-8 h-8 text-blue-300" /> Facturation Spa
          </h1>
          <Link
            href="#"
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-xl p-6 shadow-xl text-center text-gray-200">
          Aucune facture enregistrée. Utilisez le bouton ci-dessus pour en créer une.
        </div>
      </div>
